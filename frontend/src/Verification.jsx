    ...
    <div dir={i18n.language === 'ar' ? 'rtl' : 'ltr'} className="min-h-screen bg-gray-950 text-white flex items-center justify-center p-6 relative pt-24 pb-20 overflow-x-hidden">
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <div>
            <h2 className="text-xl font-extrabold text-white tracking-tight">{t('verify.title')}</h2>
            <p className="text-xs text-gray-400 mt-1">{t('verify.subtitle')}</p>
          </div>
        </div>

        {/* Developer Sandbox Notice (only in development) */}
        {(import.meta.env.DEV || window.location.hostname === 'localhost') && (
          <div className="bg-gray-950/65 border border-white/5 p-3 rounded-lg text-[10px] text-gray-400 leading-relaxed">
            <span className="font-bold text-lime-400 uppercase block mb-1">{t('verify.devHelper')}</span>
            {t('verify.logNotice')} 
            <code className="block mt-1 p-1 bg-black/45 border border-white/5 rounded text-gray-300 font-mono truncate">
        ...
        <div className="space-y-6 text-xs">
          ...
          <div className="bg-gray-950/50 p-4 rounded-xl border border-white/5 space-y-3">
            <div className="flex justify-between items-center">
              <div>
                <span className="font-bold text-white block">{t('verify.emailVerify')}</span>
            ...
            {!isEmailVerified && (
              ...
              >
                <input
                  ...
                  className="flex-1 bg-gray-900 border border-white/10 rounded px-3 py-2 text-white focus:outline-none focus:border-lime-500 font-bold tracking-widest text-center"
                />
                <button
                  type="submit"
          ...
          <div className="bg-gray-950/50 p-4 rounded-xl border border-white/5 space-y-3">
            <div className="flex justify-between items-center">
              <div>
                <span className="font-bold text-white block">{t('verify.phoneVerify')}</span>
        ...
        <div className="text-center pt-2">
          <button
            ...
            className="text-gray-400 hover:text-white transition font-medium text-xs"
          >
